...
class Vector3{
	...
	normalize(){ let mag = this.magnitude(); this.x /= mag; this.y /= mag; this.z /= mag; return this;}
...
class Matrix4{
	...
	vrotateY(rad){		Matrix4.rotateY(this.raw,rad); return this; }
	vrotateX(rad){		Matrix4.rotateX(this.raw,rad); return this; }
	vrotateZ(rad){		Matrix4.rotateZ(this.raw,rad); return this; }
